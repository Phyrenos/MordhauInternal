...
static_assert(sizeof(UMovieSceneTakeTrack) == 0x000088, "Wrong size on UMovieSceneTakeTrack");
static_assert(offsetof(UMovieSceneTakeTrack, Sections) == 0x000078, "Member 'UMovieSceneTakeTrack::Sections' has a wrong offset!");

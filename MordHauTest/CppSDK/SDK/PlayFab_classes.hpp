...
static_assert(sizeof(UPlayFabEconomyAPI) == 0x0003A0, "Wrong size on UPlayFabEconomyAPI");
...
static_assert(offsetof(UPlayFabEconomyAPI, CallAuthenticationContext) == 0x000338, "Member 'UPlayFabEconomyAPI::CallAuthenticationContext' has a wrong offset!");
static_assert(offsetof(UPlayFabEconomyAPI, RequestJsonObj) == 0x000340, "Member 'UPlayFabEconomyAPI::RequestJsonObj' has a wrong offset!");
static_assert(offsetof(UPlayFabEconomyAPI, ResponseJsonObj) == 0x000348, "Member 'UPlayFabEconomyAPI::ResponseJsonObj' has a wrong offset!");
...
static_assert(sizeof(UPlayFabServerAPI) == 0x0009A0, "Wrong size on UPlayFabServerAPI");
...
static_assert(offsetof(UPlayFabServerAPI, CallAuthenticationContext) == 0x000938, "Member 'UPlayFabServerAPI::CallAuthenticationContext' has a wrong offset!");
static_assert(offsetof(UPlayFabServerAPI, RequestJsonObj) == 0x000940, "Member 'UPlayFabServerAPI::RequestJsonObj' has a wrong offset!");
static_assert(offsetof(UPlayFabServerAPI, ResponseJsonObj) == 0x000948, "Member 'UPlayFabServerAPI::ResponseJsonObj' has a wrong offset!");

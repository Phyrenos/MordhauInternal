...
#include "BP_TurdHordeBotProjectile_classes.hpp"
#include "BP_TurdHordeBotProjectile_parameters.hpp"
...
void ABP_TurdHordeBotProjectile_C::ExecuteUbergraph_BP_TurdHordeBotProjectile(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_TurdHordeBotProjectile_C", "ExecuteUbergraph_BP_TurdHordeBotProjectile");

	Params::BP_TurdHordeBotProjectile_C_ExecuteUbergraph_BP_TurdHordeBotProjectile Parms{};
...
void ABP_TurdHordeBotProjectile_C::OnProjectileHit(const struct FVector& HitLocation, const struct FVector& HitNormal, float BounceForce, uint8 Surface, bool bHasHitWorld, bool bHasStopped)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_TurdHordeBotProjectile_C", "OnProjectileHit");

	Params::BP_TurdHordeBotProjectile_C_OnProjectileHit Parms{};

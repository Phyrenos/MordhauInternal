...
#include "BP_SmokeBombProjectile_classes.hpp"
#include "BP_SmokeBombProjectile_parameters.hpp"
...
void ABP_SmokeBombProjectile_C::ExecuteUbergraph_BP_SmokeBombProjectile(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_SmokeBombProjectile_C", "ExecuteUbergraph_BP_SmokeBombProjectile");

	Params::BP_SmokeBombProjectile_C_ExecuteUbergraph_BP_SmokeBombProjectile Parms{};
...
void ABP_SmokeBombProjectile_C::OnProjectileHit(const struct FVector& HitLocation, const struct FVector& HitNormal, float BounceForce, uint8 Surface, bool bHasHitWorld, bool bHasStopped)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_SmokeBombProjectile_C", "OnProjectileHit");

	Params::BP_SmokeBombProjectile_C_OnProjectileHit Parms{};

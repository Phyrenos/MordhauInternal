...
// 0x0010 (0x0010 - 0x0000)
struct AssetRegistry_ScanPaths final
{
public:
...
static_assert(alignof(AssetRegistry_ScanPaths) == 0x000008, "Wrong alignment on AssetRegistry_ScanPaths");
static_assert(sizeof(AssetRegistry_ScanPaths) == 0x000010, "Wrong size on AssetRegistry_ScanPaths");
static_assert(offsetof(AssetRegistry_ScanPaths, InPaths) == 0x000000, "Member 'AssetRegistry_ScanPaths::InPaths' has a wrong offset!");

...
#include "../NameCollisions.inl"
	...
	*/
	namespace Offsets
	{
		constexpr int32 GObjects = 0x057E9AF0;
		constexpr int32 AppendString = 0x0193EF70;
		constexpr int32 GNames = 0x057D0E80;
		constexpr int32 GWorld = 0x059200F8;
		constexpr int32 ProcessEvent = 0x01B65BA0;

...
#include "BP_WarAxe_DIH_classes.hpp"
#include "BP_WarAxe_DIH_parameters.hpp"
...
void ABP_WarAxe_DIH_C::ExecuteUbergraph_BP_WarAxe_DIH(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_WarAxe_DIH_C", "ExecuteUbergraph_BP_WarAxe_DIH");

	Params::BP_WarAxe_DIH_C_ExecuteUbergraph_BP_WarAxe_DIH Parms{};
...
void ABP_WarAxe_DIH_C::OnHit(class AActor* Actor, EAttackMove Move, class FName bone, const struct FVector& WorldLocation, uint8 Tier, uint8 SurfaceType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_WarAxe_DIH_C", "OnHit");

	Params::BP_WarAxe_DIH_C_OnHit Parms{};

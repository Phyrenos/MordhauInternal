...
static_assert(sizeof(UBaseDynamicMeshComponent) == 0x0004B0, "Wrong size on UBaseDynamicMeshComponent");
...
public:
	...
	uint8                                         Pad_48D[0x43];                                     // 0x048D(0x0043)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULineSetComponent) == 0x0004D0, "Wrong size on ULineSetComponent");
static_assert(offsetof(ULineSetComponent, LineMaterial) == 0x000468, "Member 'ULineSetComponent::LineMaterial' has a wrong offset!");
static_assert(offsetof(ULineSetComponent, Bounds) == 0x000470, "Member 'ULineSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(ULineSetComponent, bBoundsDirty) == 0x00048C, "Member 'ULineSetComponent::bBoundsDirty' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4C9[0xF7];                                     // 0x04C9(0x00F7)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UOctreeDynamicMeshComponent) == 0x0005C0, "Wrong size on UOctreeDynamicMeshComponent");
static_assert(offsetof(UOctreeDynamicMeshComponent, bExplicitShowWireframe) == 0x0004C8, "Member 'UOctreeDynamicMeshComponent::bExplicitShowWireframe' has a wrong offset!");
...
static_assert(sizeof(UPointSetComponent) == 0x0004D0, "Wrong size on UPointSetComponent");
static_assert(offsetof(UPointSetComponent, PointMaterial) == 0x000468, "Member 'UPointSetComponent::PointMaterial' has a wrong offset!");
static_assert(offsetof(UPointSetComponent, Bounds) == 0x000470, "Member 'UPointSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(UPointSetComponent, bBoundsDirty) == 0x00048C, "Member 'UPointSetComponent::bBoundsDirty' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4B2[0x36];                                     // 0x04B2(0x0036)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4E9[0x47];                                     // 0x04E9(0x0047)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_531[0xCF];                                     // 0x0531(0x00CF)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USimpleDynamicMeshComponent) == 0x000600, "Wrong size on USimpleDynamicMeshComponent");
static_assert(offsetof(USimpleDynamicMeshComponent, TangentsType) == 0x0004B0, "Member 'USimpleDynamicMeshComponent::TangentsType' has a wrong offset!");
static_assert(offsetof(USimpleDynamicMeshComponent, bInvalidateProxyOnChange) == 0x0004B1, "Member 'USimpleDynamicMeshComponent::bInvalidateProxyOnChange' has a wrong offset!");
static_assert(offsetof(USimpleDynamicMeshComponent, bExplicitShowWireframe) == 0x0004E8, "Member 'USimpleDynamicMeshComponent::bExplicitShowWireframe' has a wrong offset!");
static_assert(offsetof(USimpleDynamicMeshComponent, bDrawOnTop) == 0x000530, "Member 'USimpleDynamicMeshComponent::bDrawOnTop' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_485[0xCB];                                     // 0x0485(0x00CB)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UTriangleSetComponent) == 0x000550, "Wrong size on UTriangleSetComponent");
static_assert(offsetof(UTriangleSetComponent, Bounds) == 0x000468, "Member 'UTriangleSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(UTriangleSetComponent, bBoundsDirty) == 0x000484, "Member 'UTriangleSetComponent::bBoundsDirty' has a wrong offset!");

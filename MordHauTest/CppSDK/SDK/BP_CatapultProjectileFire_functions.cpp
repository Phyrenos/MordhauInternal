...
#include "BP_CatapultProjectileFire_classes.hpp"
#include "BP_CatapultProjectileFire_parameters.hpp"
...
void ABP_CatapultProjectileFire_C::ExecuteUbergraph_BP_CatapultProjectileFire(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_CatapultProjectileFire_C", "ExecuteUbergraph_BP_CatapultProjectileFire");

	Params::BP_CatapultProjectileFire_C_ExecuteUbergraph_BP_CatapultProjectileFire Parms{};
...
void ABP_CatapultProjectileFire_C::OnProjectileHit(const struct FVector& HitLocation, const struct FVector& HitNormal, float BounceForce, uint8 Surface, bool bHasHitWorld, bool bHasStopped)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_CatapultProjectileFire_C", "OnProjectileHit");

	Params::BP_CatapultProjectileFire_C_OnProjectileHit Parms{};

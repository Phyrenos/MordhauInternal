...
#include "BP_VehicleCatapult2_classes.hpp"
#include "BP_VehicleCatapult2_parameters.hpp"
...
void UBP_VehicleCatapult2_C::ExecuteUbergraph_BP_VehicleCatapult2(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VehicleCatapult2_C", "ExecuteUbergraph_BP_VehicleCatapult2");

	Params::BP_VehicleCatapult2_C_ExecuteUbergraph_BP_VehicleCatapult2 Parms{};
...
void UBP_VehicleCatapult2_C::UpdateFPCameraFor(class AMordhauCharacter* Character, float DeltaSeconds, bool bRotationOnly)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_VehicleCatapult2_C", "UpdateFPCameraFor");

	Params::BP_VehicleCatapult2_C_UpdateFPCameraFor Parms{};
...
struct FPOV UBP_VehicleCatapult2_C::PostProcessCameraPOV(const struct FPOV& InPOV, class AMordhauCharacter* Character)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_VehicleCatapult2_C", "PostProcessCameraPOV");

	Params::BP_VehicleCatapult2_C_PostProcessCameraPOV Parms{};

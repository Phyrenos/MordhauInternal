...
#include "BP_Sickle_DIH_classes.hpp"
#include "BP_Sickle_DIH_parameters.hpp"
...
void ABP_Sickle_DIH_C::ExecuteUbergraph_BP_Sickle_DIH(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Sickle_DIH_C", "ExecuteUbergraph_BP_Sickle_DIH");

	Params::BP_Sickle_DIH_C_ExecuteUbergraph_BP_Sickle_DIH Parms{};
...
void ABP_Sickle_DIH_C::OnHit(class AActor* Actor, EAttackMove Move, class FName bone, const struct FVector& WorldLocation, uint8 Tier, uint8 SurfaceType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Sickle_DIH_C", "OnHit");

	Params::BP_Sickle_DIH_C_OnHit Parms{};
